...
import com.example.akashraj.moviemanager.data.MovieDbHelper;

/**
 * Created by prakhar on 26/3/17.
 */

public class TheatreEditorActivity extends AppCompatActivity implements
     ...
     */
    private EditText mTheatreEditText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_editor_theatre);
...
//        }
        ...
        if (!TextUtils.isEmpty(ScreensString)) {
            length = Integer.parseInt(ScreensString);
        }
        values.put(MovieContract.MovieEntry.COLUMN_NUM_OF_SCREENS, length);
...
// which is the {@link CatalogActivity}.
                if (!mPetHasChanged) {
                    NavUtils.navigateUpFromSameTask(TheatreEditorActivity.this);
                    return true;
                }
