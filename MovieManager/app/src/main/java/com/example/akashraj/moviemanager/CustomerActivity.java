    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(CustomerActivity.this, CustomerEditorActivity.class);
        ...
        petListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                Intent intent = new Intent(CustomerActivity.this, EditorActivity.class);
                ...
                Uri currentPetUri = ContentUris.withAppendedId(MovieContract.MovieEntry.CONTENT_URI4, id);
...
//    }
    ...
    public Loader<Cursor> onCreateLoader(int i, Bundle bundle) {
        ...
        return new CursorLoader(this,   // Parent activity context
                MovieContract.MovieEntry.CONTENT_URI4,   // Provider content URI to query
    ...
    private void deleteAllPets() {
        int rowsDeleted = getContentResolver().delete(MovieContract.MovieEntry.CONTENT_URI4, null, null);
        Log.v("CustomerActivity", rowsDeleted + " rows deleted from pet database");
    }
}