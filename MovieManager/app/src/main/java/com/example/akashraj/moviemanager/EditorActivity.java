...
public class EditorActivity extends AppCompatActivity implements
    ...
    private void savePet() {
        ...
        values.put(MovieEntry.COLUMN_PET_WEIGHT, weight);
...
// Show a dialog that notifies the user they have unsaved changes
    ...
    public Loader<Cursor> onCreateLoader(int i, Bundle bundle) {
        ...
        String[] projection = {
                MovieEntry._ID,
                MovieEntry.COLUMN_PET_NAME,
                MovieEntry.COLUMN_PET_BREED,
                MovieEntry.COLUMN_PET_GENDER,
                MovieEntry.COLUMN_PET_WEIGHT };
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        ...
        if (cursor.moveToFirst()) {
            ...
            int nameColumnIndex = cursor.getColumnIndex(MovieEntry.COLUMN_PET_NAME);
            int breedColumnIndex = cursor.getColumnIndex(MovieEntry.COLUMN_PET_BREED);
            int genderColumnIndex = cursor.getColumnIndex(MovieEntry.COLUMN_PET_GENDER);
            int weightColumnIndex = cursor.getColumnIndex(MovieEntry.COLUMN_PET_WEIGHT);
