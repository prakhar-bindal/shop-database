...
//    }
    ...
    private void savePet() {
        ...
        // and pet attributes from the editor are the values.
        ContentValues values = new ContentValues();
        values.put(PetEntry.COLUMN_MOVIE_NAME, nameString);
        values.put(PetEntry.COLUMN_DIRECTOR_NAME, breedString);
     //   values.put(PetEntry.COLUMN_PET_GENDER, mGender);
        ...
        values.put(PetEntry.COLUMN_RUN_TIME, weight);
...
// Show a dialog that notifies the user they have unsaved changes
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        ...
        if (cursor.moveToFirst()) {
            // Find the columns of pet attributes that we're interested in
            int nameColumnIndex = cursor.getColumnIndex(PetEntry.COLUMN_MOVIE_NAME);
            int breedColumnIndex = cursor.getColumnIndex(PetEntry.COLUMN_DIRECTOR_NAME);
     //       int genderColumnIndex = cursor.getColumnIndex(PetEntry.COLUMN_PET_GENDER);
            int weightColumnIndex = cursor.getColumnIndex(PetEntry.COLUMN_RUN_TIME);
