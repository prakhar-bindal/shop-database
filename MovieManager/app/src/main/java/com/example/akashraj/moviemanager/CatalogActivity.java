...
//        // and Toto's pet attributes are the values.
//        ContentValues values = new ContentValues();
//        values.put(MovieContract.MovieEntry.COLUMN_MOVIE_NAME, "Toto");
//        values.put(MovieEntry.COLUMN_DIRECTOR_NAME, "Terrier");
//   //     values.put(MovieEntry.COLUMN_PET_GENDER, MovieEntry.GENDER_MALE);
//        values.put(MovieEntry.COLUMN_RUN_TIME, 7);
//
//        // Insert a new row for Toto into the provider using the ContentResolver.
//        // Use the {@link MovieEntry#CONTENT_URI} to indicate that we want to insert
//        // into the pets database table.
