...
public class CatalogActivity extends AppCompatActivity implements
    ...
    private void insertPet() {
        ...
        values.put(MovieContract.MovieEntry.COLUMN_PET_NAME, "Toto");
        values.put(MovieContract.MovieEntry.COLUMN_PET_BREED, "Terrier");
        values.put(MovieContract.MovieEntry.COLUMN_PET_GENDER, MovieContract.MovieEntry.GENDER_MALE);
        values.put(MovieContract.MovieEntry.COLUMN_PET_WEIGHT, 7);
    ...
    public Loader<Cursor> onCreateLoader(int i, Bundle bundle) {
        ...
        String[] projection = {
                ...
                MovieContract.MovieEntry.COLUMN_PET_NAME,
                MovieContract.MovieEntry.COLUMN_PET_BREED };
